...
import 'package:test_brik/core/network/dio_config.dart';
...
class ProductRemoteDataSourceImpl implements ProductRemoteDataSource {
  ...
  @override
  Future<Either<Failure, ProductResponseModel>> getProducts(int? limit, int? skip) async {
      try {
        final queryParameters = {
          'limit': limit,
          'skip': skip,
        };
        final result = await _dio.get(_endpoint, queryParameters: queryParameters);
  ...
  @override
  Future<Either<Failure, ProductResponseModel>> searchProduct(String query, int? limit, int? skip) async {
    try {
      final queryParameters = {
        'q': query,
        'limit': limit,
      ...
      final result = await _dio.get('$_endpoint/search', queryParameters: queryParameters);
      return Right(ProductResponseModel.fromJson(result.data));
    } on DioException catch (e) {
      return Left(ServerFailure(message: e.message));
    }
